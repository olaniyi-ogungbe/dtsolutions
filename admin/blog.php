<?php
  ...
  if(isset($_POST['submit'])){
            ...
            move_uploaded_file($post_image_temp, "../img/images/siteimages/$post_image" );
       
          
          $query = "INSERT INTO posts(post_title, post_date,post_image,post_content,post_tags,post_category) 
          
          VALUES('{$post_title}',now(),'{$post_image}','{$post_content}','{$post_tags}', '{$post_category}') "; 
